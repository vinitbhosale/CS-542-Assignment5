...
public class SpellCheckDecorator extends AbstractTextDecorator {
                        ...
                        for (int i = 0; i < wordArr.length; i++) {
                                ...
                                for (String wrd : tempWrd) {
                                        ...
                                        for (String spellCheckWrd : spellCheckWords) {
                                                // Condition to check word in sentence matches with words in misspelled
                                                // file.
                                                if (wrd.toLowerCase().trim().equals(spellCheckWrd.trim())) {
                                                        ...
                                                        String temp = "";
                                                        // Cheching if word that matches keyword contains KEYWORD_ and
                                                        // MOST_FREQUENT_ or
                                                        // just KEYWORD_ or just MOST_FREQUENT_ or nothing.
                                                        if (keyWrdIndex > -1 && mostFreqWrdIndex > -1) {
                                                                // Concating SPELLCHECK_ and _SPELLCHECK befor and after
                                                                // the word.
                                                                temp = wordArr[i].substring(0, keyWrdIndex)
                                                                                + "SPELLCHECK_"
                                                                                + wordArr[i].substring(keyWrdIndex,
                                                                                                keyWrdIndex + keyWrd
                                                                                                                .length())
                                                                                + wordArr[i].substring(mostFreqWrdIndex,
                                                                                                mostFreqWrdIndex + mostFreq
                                                                                                                .length())
                                                                                + wordArr[i].substring(wordIndex,
                                                                                                wordIndex + spellCheckWrd
                                                                                                                .length())
                                                                                + wordArr[i].substring(wordIndex
                                                                                                + spellCheckWrd.length(),
                                                                                                wordIndex + spellCheckWrd
                                                                                                                .length()
                                                                                                                + mostFreq.length()
                                                                                                                + keyWrd.length())
                                                                                + "_SPELLCHECK";
                                                                //
                                                                temp = wordIndex + spellCheckWrd.length()
                                                                                + keyWrd.length()
                                                                                + mostFreq.length() == wordArr[i]
                                                                                                .length() ? temp
                                                                                                                : temp + wordArr[i]
                                                                                                                                .substring(wordIndex
                                                                                                                                                + spellCheckWrd.length()
                                                                ...
                                                                // Concating SPELLCHECK_ and _SPELLCHECK befor and after
                                                                // the word.
                                                                temp = wordArr[i].substring(0, mostFreqWrdIndex)
                                                                                + "SPELLCHECK_"
                                                                                + wordArr[i].substring(mostFreqWrdIndex,
                                                                                                mostFreqWrdIndex + mostFreq
                                                                                                                .length())
                                                                                ...
                                                                                + "_SPELLCHECK";
                                                                //
                                                                temp = wordIndex + spellCheckWrd.length() + mostFreq
                                                                ...
                                                                //
                                                                temp = wordIndex + spellCheckWrd.length()
                                                                                + keyWrd.length() == wordArr[i].length()
                                                                                                ? temp
                                                                                                : temp + wordArr[i]
                                                                                                                .substring(wordIndex
                                                                                                                                + spellCheckWrd.length()
                                                                ...
                                                                // Concating SPELLCHECK_ and _SPELLCHECK befor and after
                                                                // the word.
                                                                temp = wordArr[i].substring(0, wordIndex)
                                                                                + "SPELLCHECK_"
                                                                                + wordArr[i].substring(wordIndex,
                                                                                                wordIndex + spellCheckWrd
                                                                                                                .length())
                                                                                + "_SPELLCHECK";
                                                                //
                                                                temp = wordIndex + spellCheckWrd.length() == wordArr[i]
                                                                                .length() ? temp
                                                                                                : temp + wordArr[i]
                                                                                                                .substring(wordIndex
                                                                                                                                + spellCheckWrd.length());
        ...
        public String toString() {
                return "Class: SpellCheckDecorator, Data members: [atd=" + atd.toString() + "id=" + id.toString()
                                + "spellCheckFp=" + spellCheckFp.toString() + "strData=" + strData.toString()
                                + "spellCheckWords=" + spellCheckWords.toString() + "index=" + index + "]";
